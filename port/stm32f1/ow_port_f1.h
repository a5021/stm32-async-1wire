 ...
 *       ~0.44µs; the same setting on a slow clock (≤16MHz) would sample at
 *       ~2MHz and add ~4µs, pushing '1' slot captures from ~8µs to 11-12µs
 *       — past ONEWIRE_SHORT_PULSE_MAX. On slow clocks use fCK_INT with N=4
