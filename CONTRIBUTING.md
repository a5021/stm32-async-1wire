...
4. Run the code quality checks used in CI:
   - `clang-format --dry-run --Werror include/ds18b20.h src/ds18b20.c src/internal/ds18b20_search.c src/internal/ds18b20_txn.c src/internal/ds18b20_resolution.c src/internal/ds18b20_measure.c examples/1_basic/main.c`
...
- Follow the existing naming conventions in `include/` and `src/`.
